...
namespace FlatPanelTest.Controls
{
    ...
    [Designer(typeof(Controls.FlatScrollBarDesigner))]
    [ToolboxBitmap(typeof(ScrollBar))]
    [DefaultEvent("Scroll")]
    [DefaultProperty("Value")]
    public class FlatScrollBar : Control, FlatPanelTest.ITheme
    {
        ...
        private Controls.ScrollBarOrientation _orientation = FlatPanelTest.Controls.ScrollBarOrientation.Vertical; // The scrollbar orientation - horizontal / vertical.
        ...
        private readonly Timer progressTimer = new Timer(); // The progress timer for moving the thumb.

        private FlatPanelTest.UITheme _theme = FlatPanelTest.UITheme.VS2019LightBlue;
        ...
        [System.ComponentModel.DefaultValueAttribute(FlatPanelTest.Controls.ScrollBarOrientation.Vertical)]
        public Controls.ScrollBarOrientation Orientation
        {
            get
            {
                return _orientation;
            ...
            set
            {
                ...
                if (value != _orientation)
                {
                    ...
                    _orientation = value;
                    _scrollOrientation = value == FlatPanelTest.Controls.ScrollBarOrientation.Vertical ? ScrollOrientation.VerticalScroll : ScrollOrientation.HorizontalScroll;
        ...
        [DefaultValue(typeof(FlatPanelTest.UITheme), "1")]
        public FlatPanelTest.UITheme Theme
        {
            get
            {
                return _theme;
            ...
            set
            {
                ...
                if (_theme == FlatPanelTest.UITheme.VS2019DarkBlue)
                {
                ...
                else if (_theme == FlatPanelTest.UITheme.VS2019LightBlue)
                {
                ...
                else if (_theme == FlatPanelTest.UITheme.Custom)
                {
                    ParentTheme = false;
        ...
        {
            FlatPanelTest.NativeMethods.SendMessage(Handle, SETREDRAW, false, 0);
            _isUpdating = true;
        }

        public void EndUpdate()
        {
            FlatPanelTest.NativeMethods.SendMessage(Handle, SETREDRAW, true, 0);
            _isUpdating = false;
            SetUpScrollBar();
            Refresh();
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_topBarClicked)
            {
                ...
                if (_orientation == FlatPanelTest.Controls.ScrollBarOrientation.Vertical)
                {
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (_rectThumb.Contains(mouseLocation))
                {
                    ...
                    _thumbClicked = true;
                    _thumbPosition = _orientation == FlatPanelTest.Controls.ScrollBarOrientation.Vertical ? mouseLocation.Y - _rectThumb.Y : mouseLocation.X - _rectThumb.X;
                ...
                {
                    _trackPosition = _orientation == FlatPanelTest.Controls.ScrollBarOrientation.Vertical ? mouseLocation.Y : mouseLocation.X;

                    if (_trackPosition < (_orientation == FlatPanelTest.Controls.ScrollBarOrientation.Vertical ? _rectThumb.Y : _rectThumb.X))
                    {
                        _topBarClicked = true;
                    }
                    else
            ...
            {
                _trackPosition = _orientation == FlatPanelTest.Controls.ScrollBarOrientation.Vertical ? e.Y : e.X;
            }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left) // Moving and holding the left mouse button
            {
                ...
                if (_thumbClicked)
                {
                    ...
                    int pos = _orientation == FlatPanelTest.Controls.ScrollBarOrientation.Vertical ? e.Location.Y : e.Location.X;
        ...
        protected override bool ProcessDialogKey(Keys keyData)
        {
            ...
            if (_orientation == FlatPanelTest.Controls.ScrollBarOrientation.Horizontal)
            {
                keyUp = Keys.Left;
                keyDown = Keys.Right;
            }
        ...
        private void SetUpScrollBar()
        {
            ...
            if (_orientation == FlatPanelTest.Controls.ScrollBarOrientation.Vertical)
            {
                ...
                _rectThumb = new Rectangle((int)Math.Round(ClientRectangle.Right / 2d) - (int)Math.Round(_thumbWidth / 2d), ClientRectangle.Y + _arrowHeight + 1, _thumbWidth, _thumbHeight);
                _rectTopArrow = new Rectangle((int)Math.Round(ClientRectangle.Right / 2d) - (int)Math.Round(_arrowWidth / 2d) + 1, ClientRectangle.Y + 1, _arrowWidth, _arrowHeight);
                _rectBottomArrow = new Rectangle((int)Math.Round(ClientRectangle.Right / 2d) - (int)Math.Round(_arrowWidth / 2d), ClientRectangle.Bottom - _arrowHeight - 1, _arrowWidth, _arrowHeight);
                _thumbPosition = (int)Math.Round(_rectThumb.Height / 2d);
            ...
            else
            {
                ...
                _rectChannel = _rectClickedBar;
                _rectThumb = new Rectangle(ClientRectangle.X + _arrowWidth + 1, (int)Math.Round(ClientRectangle.Bottom / 2d) - (int)Math.Round(_thumbHeight / 2d), _thumbWidth, _thumbHeight);
                _rectTopArrow = new Rectangle(ClientRectangle.X + 2, (int)Math.Round(ClientRectangle.Bottom / 2d) - (int)Math.Round(_arrowHeight / 2d) + 1, _arrowWidth, _arrowHeight);
                _rectBottomArrow = new Rectangle(ClientRectangle.Right - _arrowWidth - 2, (int)Math.Round(ClientRectangle.Bottom / 2d) - (int)Math.Round(_arrowHeight / 2d), _arrowWidth, _arrowHeight);
                _thumbPosition = (int)Math.Round(_rectThumb.Width / 2d);
        ...
        private int GetThumbSize()
        {
            ...
            int trackSize = _orientation == FlatPanelTest.Controls.ScrollBarOrientation.Vertical ? Height - 2 * _arrowHeight : Width - 2 * _arrowWidth;
        ...
        private void DrawBackground(Graphics g, Rectangle rect)
        {
            ...
            using (var sb = new SolidBrush(Color.FromArgb(200, _backColor))) // 127 es 50% de 255
            {
        ...
        private void DrawThumb(Graphics g, Rectangle rect, ScrollBarState state)
        {
            ...
            using (var sb = new SolidBrush(Color.FromArgb(90, _thumbColors[index]))) // 127 es 50% de 255
            {
                g.FillRectangle(sb, rect);
            }
        ...
        private void DrawArrowButton(Graphics g, Rectangle rect, ScrollBarArrowButtonState state, bool arrowUp, Controls.ScrollBarOrientation orientation)
        {
            ...
            if (orientation == FlatPanelTest.Controls.ScrollBarOrientation.Vertical)
            {
        ...
        private static Point[] GetDownArrow(Rectangle r)
        {
            ...
            var middle = new Point(r.Left + (int)Math.Round(r.Width / 2d) - 1, r.Top + (int)Math.Round(r.Height / 2d) + 1);
